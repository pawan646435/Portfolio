...
export default function EntryGate() {
  ...
  const enter = () => {
    ...
    setExiting(true);
    // monogram brighten (0s) + content fade (0.2s) + gold sweep (0.4s)
    // + fade to black (0.7s) before Room I appears
      ...
      {!hasEntered && (
        ...
        >
          ...
          >
            ...
            >
              ...
              <p
                ...
                style={{ fontWeight: 300, fontSize: "1.15rem", color: GOLD, letterSpacing: "0.02em" }}
              >
                of Pawan Kumar
              </p>
            </motion.div>
            ...
            <motion.button
              ...
              style={{ fontSize: "1.35rem", letterSpacing: "0.04em", minHeight: 56 }}
              initial={{ opacity: 0, y: 8 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <motion.button
            ...
            transition={t(1, 1.8)}
            className="fixed bottom-8 left-1/2 -translate-x-1/2 font-jetbrains-mono text-[0.65rem] flex items-center justify-center"
            style={{
